...
export const experienceData: ExperienceData = {
  ...
  heading: "Experience",
  description: "A chronological timeline of engineering leadership, team enablement, and high-impact delivery.",
  items: [
    {
      id: "virtusa-lead",
      ...
      period: "Present",
      isCurrent: true,
      teamSummary: "Leading a dedicated 3-person frontend engineering squad driving sprint cadence, architectural alignment, and delivery velocity.",
      projectHighlight: "Helio — Greenfield enterprise AI agent orchestration platform.",
      bulletPoints: [
    ...
    },
    {
      ...
      period: "Prior",
      isCurrent: false,
      teamSummary: "Delivered enterprise web applications and responsive client platforms within cross-functional Agile teams.",
      projectHighlight: "Enterprise Client Portals & Scalable UI Design Systems.",
      bulletPoints: [
