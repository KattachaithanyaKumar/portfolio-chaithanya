...
export const projectsData: ProjectsData = {
  ...
  description: "A showcase of open-source CLI tools, component libraries, full-stack platforms, and AI-powered utilities.",
  projects: [
    {
      id: "jtracker",
      title: "JTracker",
      ...
      description: "A local-first CLI sprint tracker published as an npm scoped package. Enables developers to manage task boards, log time, and sync backlog directly from the terminal without cloud lock-in.",
      highlights: [
      ...
      npmUrl: "https://www.npmjs.com/package/@chaithanya-kumar-katta/jtracker/v/1.0.0-beta.2",
    ...
    },
    {
      ...
      description: "A deployed, accessible React component library crafted with modern styling tokens, keyboard navigation primitives, and full TypeScript typings.",
      highlights: [
      ...
      liveUrl: "https://www.npmjs.com/package/@chaithanya-kumar-katta/feather-ui",
    ...
    },
    {
      ...
      description: "An AI-powered README and project documentation generator that analyzes repository structures, licenses, and dependencies to craft clean, markdown-ready documentation.",
      highlights: [
    ...
    },
    {
      ...
      description: "A PG and hotel rental booking platform with property listings, room filtering, date-based booking reservations, and tenant management.",
      highlights: [
    ...
    },
    {
      ...
      description: "A Medium-style collaborative blogging platform featuring rich text editing, tag indexing, reading lists, user following, and responsive article layouts.",
      highlights: [
      ...
      stack: ["React", "TypeScript", "Tailwind", "Ant Design", "Redux Toolkit", "Node.js", "Express", "Sequelize", "JWT"],
      // liveUrl: "https://example.com",
      githubUrl: "https://github.com/KattachaithanyaKumar/quill-blogging-platform",
    },
    {
      id: "orbit",
      title: "Orbit",
      ...
      description: "A Notion-like collaborative workspace application — one workspace where every file, folder, and idea stays in sync.",
      highlights: [
      ...
      stack: ["Next.js", "React", "TypeScript", "NestJS", "TypeORM", "MySQL", "Redux Toolkit", "Tailwind CSS"],
