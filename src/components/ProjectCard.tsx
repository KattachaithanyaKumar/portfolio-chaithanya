...
export const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  const remainingTagsText = remainingCount > 0 ? project.stack.slice(4).join(', ') : '';
        ...
        <div className="flex flex-wrap items-center gap-1.5 mb-4">
          ...
          {remainingCount > 0 && (
            <button
              ...
              title={showAllTags ? "Show fewer tags" : `Additional: ${remainingTagsText} (Click to toggle)`}
              aria-label={showAllTags ? "Show fewer tags" : `Show ${remainingCount} more tags: ${remainingTagsText}`}
            >
